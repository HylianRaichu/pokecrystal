...
FalknerGroup:
	...
	db  13, PIDGEOTTO,  TACKLE, MUD_SLAP, PECK, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, JIGGLYPUFF, DOUBLESLAP, MIMIC, DISABLE, ROLLOUT
...
BugsyGroup:
	...
	db 15, SPINARAK,   CONSTRICT, STRING_SHOT, POISON_STING, NO_MOVE
	db 15, LEDYBA,     TACKLE, SUPERSONIC, COMET_PUNCH, NO_MOVE
...
MortyGroup:
	...
	db 23, MISDREAVUS, SPITE, MEAN_LOOK, SHADOW_BALL, NIGHT_SHADE
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 30, SNEASEL,    HEADBUTT, ICY_WIND, FAINT_ATTACK, REST
	db 32, DEWGONG,    HEADBUTT, ICY_WIND, WATERFALL, REST
...
ChuckGroup:
	...
	db 29, PRIMEAPE,   SEISMIC_TOSS, RAGE, KARATE_CHOP, FURY_SWIPES
...
ClairGroup:
	...
	db 38, GYARADOS,   CURSE, SURF, THRASH, DRAGONBREATH
...
WillGroup:
	...
	db 40, ESPEON,     PROTECT, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 41, JYNX,       SHADOW_BALL, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
...
BrunoGroup:
	...
	db 43, POLIWRATH,  BIND, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
...
KarenGroup:
	...
	db 42, UMBREON,    MOONLIGHT, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db 42, SNEASEL,    BEAT_UP, TOXIC, SHADOW_BALL, REST
	db 45, TYRANITAR,  CRUNCH, ROCK_SLIDE, CURSE, EARTHQUAKE
...
KogaGroup:
	...
	db 43, WEEZING,    PROTECT, TOXIC, EXPLOSION, SPIKES
...
LtSurgeGroup:
	...
	db 40, JOLTEON,    AGILITY, DOUBLE_TEAM, SWIFT, THUNDERBOLT
